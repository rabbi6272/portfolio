...
export default function InfiniteScroll({
  ...
  useEffect(() => {
    ...
    if (autoplay) {
      ...
      const speedPerFrame =
        (window.innerWidth >= 768 ? 1 : 2.5) * directionFactor;
  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, i) => (
          <div
            className="flex flex-col items-center justify-center p-4 text-xl font-normal text-center border-2 border-gray-500 rounded-lg select-none box-border relative"
            key={i}
            style={{
